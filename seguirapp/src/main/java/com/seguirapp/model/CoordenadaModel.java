...
public class CoordenadaModel {
    ...
    private Collection<EquipamentoModel> equipamentosByIdCoordenada;
    ...
    @OneToMany(mappedBy = "coordenadaByIdCoordenada")
    public Collection<EquipamentoModel> getEquipamentosByIdCoordenada() {
        return equipamentosByIdCoordenada;
    }

    public void setEquipamentosByIdCoordenada(Collection<EquipamentoModel> equipamentosByIdCoordenada) {
